...
import com.duy.aahomeinternet.items.MessengeItem;
...
//                        ? R.drawable.ic_air_conditioner :
    ...
    public int removeAllDevice() {
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        return sqLiteDatabase.delete(TABLE_DEVICES, null, null);
    }

    public ArrayList<String> getListPinLight() {
    ...
    public void addDevice(ArrayList<DeviceItem> list) {
