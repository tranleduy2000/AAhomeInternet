 ...
 */
public class FragmentChart extends Fragment implements MainActivity.ChartListener {
...
//        muiltiTempRenderer.setExternalZoomEnabled(true);
        ...
        //add com.example.tranleduy.aahome.com.duy.aahomeinternet.data
    ...
    private XYSeries getSeriesHumi() {
        ...
        for (int i = 0; i < 24; i++) {
//            Date date = new Date(com.example.tranleduy.aahome.com.duy.aahomeinternet.data.get(i).getMillisSecond());
